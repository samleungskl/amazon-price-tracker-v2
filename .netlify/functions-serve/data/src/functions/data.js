...
// functions/helpers/airtable/getData.js
var require_getData = __commonJS({
  "functions/helpers/airtable/getData.js"(exports2, module2) {
    var { base } = require_airtable2();
    var formattedReturn = require_formattedReturn();
    module2.exports = async (event) => {
      try {
        const extractFieldData = (dataAryOfObj) => {
          const result2 = dataAryOfObj.map((element) => {
