...
// node_modules/airtable/node_modules/node-fetch/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/airtable/node_modules/node-fetch/lib/index.js"(exports2, module2) {
    "use strict";
  ...
  "node_modules/airtable/lib/object_to_query_param_string.js"(exports2, module2) {
    ...
    function buildParams(prefix, obj, addFn) {
      if (isArray_1.default(obj)) {
        ...
        for (var _i = 0, _a4 = keys_1.default(obj); _i < _a4.length; _i++) {
          var key = _a4[_i];
          var value = obj[key];
...
var require_deprecate = __commonJS({
  "node_modules/airtable/lib/deprecate.js"(exports2, module2) {
    ...
    function deprecate3(fn, key, message) {
      return function() {
        var args = [];
    ...
    function callbackToPromise(fn, context, callbackArgIndex) {
      ...
      return function() {
        ...
        if (typeof callbackArg === "function") {
          ...
          for (var i2 = 0; i2 < argLen; i2++) {
            args_1.push(callArgs[i2]);
          }
  ...
  "node_modules/airtable/lib/query.js"(exports2, module2) {
    ...
    var Query = function() {
      ...
      Query2.validateParams = function(params) {
        ...
        var ignoredKeys = [];
        var errors = [];
        for (var _i = 0, _a4 = keys_1.default(params); _i < _a4.length; _i++) {
          var key = _a4[_i];
      ...
      Table2.prototype._destroyRecord = function(recordIdsOrId, done) {
        ...
        if (Array.isArray(recordIdsOrId)) {
          ...
          this._base.runAction("delete", "/" + this._urlEncodedNameOrId(), queryParams, null, function(err, response, results) {
            ...
            var records = results.records.map(function(_a4) {
              var id = _a4.id;
  ...
  "node_modules/airtable/lib/http_headers.js"(exports2, module2) {
    ...
    var HttpHeaders = function() {
      ...
      HttpHeaders2.prototype.toJSON = function() {
        var result = {};
        for (var _i = 0, _a4 = keys_1.default(this._headersByLowercasedKey); _i < _a4.length; _i++) {
          var lowercasedKey = _a4[_i];
        ...
        if (resp.status === 429 && !base._airtable._noRetryIfRateLimited) {
          ...
          resp.json().then(function(body) {
            ...
            Object.keys(resp).forEach(function(property) {
              r2[property] = resp[property];
            });
            r2.body = body;
            r2.statusCode = resp.status;
            callback(error, r2, body);
          }).catch(function() {
  ...
  "node_modules/airtable/lib/base.js"(exports2, module2) {
    ...
    var Base = function() {
      ...
      Base2.prototype.makeRequest = function(options) {
        ...
        var controller = new abort_controller_1.default();
        var headers = this._getRequestHeaders(Object.assign({}, this._airtable._customHeaders, (_a4 = options.headers) !== null && _a4 !== void 0 ? _a4 : {}));
        var requestOptions = {
          method,
          headers,
          signal: controller.signal
      ...
      Base2.prototype._getRequestHeaders = function(headers) {
        ...
        for (var _i = 0, _a4 = keys_1.default(headers); _i < _a4.length; _i++) {
          var headerKey = _a4[_i];
          result.set(headerKey, headers[headerKey]);
        }
        return result.toJSON();
      };
      Base2.prototype._checkStatusForError = function(statusCode, body) {
        var _a4 = (body !== null && body !== void 0 ? body : { error: {} }).error, error = _a4 === void 0 ? {} : _a4;
...
var require_airtable = __commonJS({
  "node_modules/airtable/lib/airtable.js"(exports2, module2) {
    ...
    var Airtable = function() {
      ...
      Airtable2.configure = function(_a4) {
        var apiKey = _a4.apiKey, endpointUrl = _a4.endpointUrl, apiVersion = _a4.apiVersion, noRetryIfRateLimited = _a4.noRetryIfRateLimited, requestTimeout = _a4.requestTimeout;
...
// functions/helpers/airtable/airtable.js
var require_airtable2 = __commonJS({
  "functions/helpers/airtable/airtable.js"(exports2, module2) {
    require_main().config();
    var airTableAPI = process.env.REACT_APP_AIRTABLE_API_KEY;
    var airTableBase = process.env.REACT_APP_AIRTABLE_BASE;
...
// functions/helpers/airtable/formattedReturn.js
var require_formattedReturn = __commonJS({
  "functions/helpers/airtable/formattedReturn.js"(exports2, module2) {
    module2.exports = (statusCode, body) => {
      return {
        statusCode,
...
// functions/helpers/airtable/createData.js
var require_createData = __commonJS({
  "functions/helpers/airtable/createData.js"(exports2, module2) {
    var { base } = require_airtable2();
    var formattedReturn = require_formattedReturn();
    module2.exports = async (amazonData, tableName) => {
      try {
        const createdCourse = await base(tableName).create(amazonData);
...
// functions/helpers/airtable/updateData.js
var require_updateData = __commonJS({
  "functions/helpers/airtable/updateData.js"(exports2, module2) {
    var { base } = require_airtable2();
    var formattedReturn = require_formattedReturn();
    module2.exports = async (amazonData, tableName) => {
      try {
...
// functions/helpers/rapidApi/matchDataWithUid.js
var require_matchDataWithUid = __commonJS({
  "functions/helpers/rapidApi/matchDataWithUid.js"(exports2, module2) {
    var matchDataWithUid2 = (airtableAsin, formattedData) => {
      const dataWithID = formattedData.map((element) => {
        const asin = element.fields.asin;
        const airTabbleID = airtableAsin.find((element2) => element2.asin === asin);
        element.id = airTabbleID.asinUid;
        return element;
      });
      return dataWithID;
    };
    module2.exports = { matchDataWithUid: matchDataWithUid2 };
  }
});

// functions/helpers/rapidApi/formattedAsinData.js
var require_formattedAsinData = __commonJS({
  "functions/helpers/rapidApi/formattedAsinData.js"(exports2, module2) {
    var formatAsinData2 = (returnedAmazonData) => {
    ...
    module2.exports = { formatAsinData: formatAsinData2 };
  }
});

// functions/helpers/rapidApi/formattedPriceData.js
var require_formattedPriceData = __commonJS({
  "functions/helpers/rapidApi/formattedPriceData.js"(exports2, module2) {
    var formatPriceData2 = (returnedAmazonData) => {
      return returnedAmazonData.map((element) => {
        return {
          "fields": {
    ...
    module2.exports = { formatPriceData: formatPriceData2 };
  }
});

// functions/helpers/rapidApi/formattedAsinArray.js
var require_formattedAsinArray = __commonJS({
  "functions/helpers/rapidApi/formattedAsinArray.js"(exports2, module2) {
    var formatAsinArray = (AsinArray) => {
      return AsinArray.join("%2C");
    };
    module2.exports = { formatAsinArray };
  }
});

// functions/helpers/rapidApi/rapidApiGetData.js
var require_rapidApiGetData = __commonJS({
  "functions/helpers/rapidApi/rapidApiGetData.js"(exports2, module2) {
    init_src();
    var import_formattedAsinArray = __toESM(require_formattedAsinArray());
    require_main().config();
    var rapidApiKey = process.env.REACT_APP_RAPIDAPI_KEY;
    var rapidApiHost = process.env.REACT_APP_RAPIDAPI_HOST;
    var rapidApiUrl = process.env.REACT_APP_RAPIDAPI_URL;
    module2.exports = async (asinArray) => {
      const resultWithPercentage = (0, import_formattedAsinArray.formatAsinArray)(asinArray);
...
init_src();
var import_createData = __toESM(require_createData());
var import_updateData = __toESM(require_updateData());
var import_matchDataWithUid = __toESM(require_matchDataWithUid());
var import_formattedAsinData = __toESM(require_formattedAsinData());
var import_formattedPriceData = __toESM(require_formattedPriceData());
var getAmazonData = require_rapidApiGetData();
var handler = async function(event, context) {
  const loadData = async () => {
    try {
      ...
      const cleanedAmazonPriceData = await (0, import_formattedPriceData.formatPriceData)(amazonJson);
      const cleanedAmazonAsinData = await (0, import_formattedAsinData.formatAsinData)(amazonJson);
      const dataWithUid = await (0, import_matchDataWithUid.matchDataWithUid)(result.asin, cleanedAmazonAsinData);
      (0, import_createData.default)(cleanedAmazonPriceData, "data");
      (0, import_updateData.default)(dataWithUid, "asin");
    } catch (error) {
      console.error(error);
    }
  };
